...
Nei nostri ambiti di interesse i dati originali sono normalmente su un foglio di carta: che sia il blocco di appunti del laboratorio o le schede dei rilievi di campo, normalmente questi vengono registrati a matita<sup id="a2">[2](#f2)</sup>, con tutta una serie di note a margine, eccezioni, punti interrogativi.
...
Per i casi più comuni velidi strumenti sono già stati sviluppati, e di nuovi ne possono essere approntati in caso si trovino casi ricorrenti, come la correzione automatica dei taxa botanici, sia per errori di ortografia che per sinonimi non più in uso.
